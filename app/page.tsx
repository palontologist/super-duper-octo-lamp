...
export default function Page() {
  return (
    <div className="min-h-screen bg-[#111] flex flex-col md:flex-row relative">
      {/* Background Image */}
      <div 
      ...
      <div className="relative z-10 flex flex-col md:flex-row min-h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8">
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold text-center text-white mb-4 sm:mb-6">
            Align your daily actions with <span className="block">your core mission</span>
          </h1>
          <p className="text-base sm:text-lg md:text-2xl text-center text-white/80 max-w-2xl px-4">
          The OS for <MorphingText texts={["Founders", "Experts" , "Students", "Teams"]} /> Focus.
          </p>
        </div>
        {/* Divider */}
